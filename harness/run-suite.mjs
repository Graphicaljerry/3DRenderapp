...
const STUB_PROBES = [
  ...
  "stop-e2e", "regress-465-e2e", "hd-photo-e2e", "photolabel-e2e", "thinkmd-e2e", "truncation-e2e", "tokentrim-e2e", "balance-live-e2e",
  "mainblock-e2e", "accuracy-e2e", "receipt-e2e", "steps-e2e", "guided-e2e",
];
